...
- Приложение не предоставляет функционал воспроизведения музыки
...
1. Доступ к персональной коллекции треков предоставляется только владельцу профиля
...
### 3.2.3 Ограничения
1. Приложение разрабатывается для Desktop-платформ (Windows, Linux)
