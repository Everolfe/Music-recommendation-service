...
2.6 [Оценить трек](#rate_music)     
2.7 [Получить рекомендации](#get_recs)  
2.8 [Создать плейлист](#create_playlist)   
2.9 [Редактировать или удалить плейлист](#edit_or_del_playlist)  
...
## 2.9 Редактировать или удалить плейлист
...
**Предусловия.** Зарегистрированный пользователь находится в главном окне.  
**Основной поток.**
1. Пользователь нажимает “Exit”;
